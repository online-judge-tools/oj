...
class DownloadYukicoderTest(unittest.TestCase):
    ...
    def test_call_download_yukicoder_no_9002(self):
        self.snippet_call_download('http://yukicoder.me/problems/no/9002', {
    ...
    def test_call_download_yukicoder_no_104(self):
        self.snippet_call_download('http://yukicoder.me/problems/no/104', {
    ...
    def test_call_download_yukicoder_no_400(self):
        self.snippet_call_download('http://yukicoder.me/problems/no/400', {
    ...
    def test_call_download_yukicoder_no_260(self):
        self.snippet_call_download('http://yukicoder.me/problems/no/260/', {
