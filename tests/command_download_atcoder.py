...
class DownloadAtCoderTest(unittest.TestCase):
    ...
    def test_call_download_atcoder_icpc2013spring_a(self):
        self.snippet_call_download('http://jag2013spring.contest.atcoder.jp/tasks/icpc2013spring_a', {
    ...
    def test_call_download_atcoder_arc035_a(self):
        self.snippet_call_download('http://arc035.contest.atcoder.jp/tasks/arc035_a', {
    ...
    def test_call_download_atcoder_arc001_1(self):
        self.snippet_call_download('http://arc001.contest.atcoder.jp/tasks/arc001_1', {
    ...
    def test_call_download_atcoder_agc001_a(self):
        self.snippet_call_download('http://agc001.contest.atcoder.jp//////tasks//////agc001_a//////?hoge=fuga#piyo', {
    ...
    def test_call_download_atcoder_abc073_a(self):
        self.snippet_call_download('https://beta.atcoder.jp/contests/abc073/tasks/abc073_a', {
    ...
    def test_call_download_atcoder_ddcc2017_qual_a(self):
        self.snippet_call_download('https://beta.atcoder.jp/contests/ddcc2017-qual/tasks/ddcc2017_qual_a', {
    ...
    def test_call_download_atcoder_agc029_a(self):
        self.snippet_call_download('https://atcoder.jp/contests/agc029/tasks/agc029_a', {
