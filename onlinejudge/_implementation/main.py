...
''')
    ...
    subparser.add_argument('--side-by-side', dest='display-mode', action='store_const', const='side-by-side', help='display an output and the correct answer with side by side mode (equivalent to --display-mode side-by-side)')
